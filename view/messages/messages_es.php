<?php
  ...
  array(
    ...
    "Leave" => "Abandonar",
    "Reservation successfully cancelled" => "Reserva cancelada satisfactoriamente",
    ...
    "Reservation successfully added" => "Reserva añadida satisfactoriamente",
    "There is no reservation with that id" => "No hay ninguna reserva con ese id",
    "Reservation successfully deleted" => "Reserva eliminada satisfactoriamente",
